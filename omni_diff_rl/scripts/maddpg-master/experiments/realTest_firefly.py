...
def parse_args():
    ...
    parser.add_argument("--load-dir", type=str, default="../tmp/policy_new4/", help="directory in which training state and model are loaded")
...
def train(arglist):
    with U.single_threaded_session():
        ...
        action_save = []
        pos = [0, 0, 0]
        file_folder_name = "../save_data/训练数据/policy_new4"  # policy_continueTest
